...
const SITE_FUNCTIONS: SiteFunction[] = [
  { path: "/jurisdiction", label: "Jurisdiction & Agencies", section: "Directory", keywords: ["jurisdiction", "agency", "bureau", "BIA", "HHS", "IHS", "lookup"] },
  { path: "/intake", label: "Document Intake", section: "Directory", keywords: ["intake", "document", "analyze", "route", "classify"] },
...
const LS_RECENT_PREFIX = "authority-directory:";
...
function recordPath(r: SearchRecord): string {
  ...
  return fn ? fn(r.entityId) : `/jurisdiction`;
}
      ...
      <div className="relative w-full max-w-xl mx-4 rounded-xl shadow-2xl overflow-hidden"
        ...
        <div className="flex items-center gap-2.5 px-4 py-3 border-b" style={{ borderColor: "hsl(var(--border))" }}>
          ...
          <input ref={inputRef} value={query} onChange={e => setQuery(e.target.value)} onKeyDown={onKeyDown}
            placeholder="Search agencies, case files, legal authorities…"
