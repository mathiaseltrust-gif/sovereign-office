...
const SITE_FUNCTIONS: SiteFunction[] = [
  { path: "/", label: "Matter Queue", section: "TRACE", keywords: ["queue", "dashboard", "matters", "active", "home"] },
  { path: "/matters/new", label: "New Matter", section: "TRACE", keywords: ["new", "submit", "matter", "create", "add"] },
...
function pageLabelFor(path: string): string {
  ...
  return path.replace(/^\//, "").replace(/-/g, " ").replace(/\b\w/g, l => l.toUpperCase()) || "Matter Queue";
}
      ...
      <div className="relative w-full max-w-xl mx-4 rounded-xl shadow-2xl overflow-hidden"
        ...
        <div className="flex items-center gap-2.5 px-4 py-3 border-b" style={{ borderColor: "hsl(var(--border))" }}>
          ...
          <input ref={inputRef} value={query} onChange={e => setQuery(e.target.value)} onKeyDown={onKeyDown}
            placeholder="Search matters, NIAC queue, compliance records…"
