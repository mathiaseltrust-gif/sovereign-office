...
const SITE_FUNCTIONS: SiteFunction[] = [
  { path: "/", label: "Overview", section: "Trust", keywords: ["overview", "home", "dashboard", "portal"] },
  { path: "/instruments", label: "Trust Instruments", section: "Trust", keywords: ["instrument", "trust", "list", "all"] },
  { path: "/instruments/new", label: "New Instrument", section: "Trust", keywords: ["create", "new", "instrument", "add"] },
  { path: "/filings", label: "Filings", section: "Trust", keywords: ["filing", "filed", "submission"] },
  { path: "/nfr", label: "Notice of Federal Review", section: "Governance", keywords: ["nfr", "federal", "review", "notice"] },
  { path: "/elder-advisory", label: "Elder Advisory", section: "Governance", keywords: ["elder", "advisory", "council"] },
  { path: "/member-profile", label: "Member Profile", section: "Members", keywords: ["member", "profile", "identity"] },
  { path: "/family-governance", label: "Family Governance", section: "Governance", keywords: ["family", "governance", "plan"] },
  { path: "/niac", label: "NIAC § 527 Political", section: "Governance", keywords: ["niac", "political", "527"] },
...
function recordPage(path: string) {
  if (!path || path === "/") return;
  try {
      ...
      <div className="relative w-full max-w-xl mx-4 rounded-xl shadow-2xl overflow-hidden"
        ...
        <div className="flex items-center gap-2.5 px-4 py-3 border-b" style={{ borderColor: "hsl(var(--border))" }}>
          ...
          <input ref={inputRef} value={query} onChange={e => setQuery(e.target.value)} onKeyDown={onKeyDown}
            placeholder="Search trust instruments, filings, members…"
