...
import { MEDICAL_ENTITY_IDS, MEDICAL_CENTER_DIRECTOR, MEDICAL_CENTER_DIRECTOR_TITLE } from "@/lib/medical-center";
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="rounded-lg border bg-card p-4 space-y-2">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="font-mono text-xs font-bold text-foreground">{MEDICAL_ENTITY_IDS[0]?.npi}</span>
            </div>
