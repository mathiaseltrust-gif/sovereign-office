...
const WORDS: WordEntry[] = [
  ...
  },
  {
    ...
    oneLiner: "An enforceable fiduciary duty of the United States toward Indian tribes and Indian people — arising from treaties, federal dealings, and congressional enactments; not limited to BIA recognition status, reservation boundaries, or administrative rosters.",
    layers: {
      ordinary:       { label: "Common Understanding", content: "A protective relationship between the U.S. government and Indian tribes — often described as a special duty of care or guardianship. Frequently understood as a benefit program or administrative services relationship.", citation: "Everyday usage" },
      historical:     { label: "Historical & Structural Foundation", content: "The trust relationship developed through treaties, federal dealings, congressional enactments, territorial expansion, protection obligations, and the continued existence of tribal nations within the United States legal framework. It is older than most federal agencies — predating the BIA (1824), the Department of the Interior (1849), and nearly every modern Indian statute. The trust responsibility is not a benefits program: it is a fiduciary relationship arising from federal power over Indian affairs and the corresponding obligations that attach to that power. Courts have repeatedly recognized that federal agencies and officials dealing with Indian affairs may carry fiduciary obligations, heightened duties of protection, and legally enforceable responsibilities involving tribal lands, tribal assets, governmental functions, treaty obligations, protected Indian interests, and beneficiary welfare.", citation: "Cherokee Nation v. Georgia, 30 U.S. 1 (1831); treaty obligations, 1778–1871; Seminole Nation v. United States, 316 U.S. 286 (1942)" },
      federal:        { label: "Federal Legal Scope & Enforcement", content: "The Snyder Act (1921) establishes the broadest statutory basis — 'Indians throughout the United States.' The trust responsibility has operational legal consequences: United States v. Mitchell, 463 U.S. 206 (1983) confirmed federal liability for breach of fiduciary duties involving Indian trust assets. Cobell v. Salazar, 573 F.3d 808 (D.C. Cir. 2009) recognized large-scale fiduciary breaches and enforceable trust-accounting obligations. United States v. White Mountain Apache Tribe, 537 U.S. 465 (2003) confirmed fiduciary duties arise where the United States occupies, controls, or uses tribal property. McGirt v. Oklahoma, 591 U.S. ___ (2020) reaffirmed that tribal jurisdiction and reservation status persist unless Congress clearly provides otherwise. The trust responsibility is not limited to reservation boundaries, BIA recognition systems, or CDIB possession — it may extend to protected tribal interests, identifiable tribal communities, tribal governmental functions, tribal beneficiaries, restricted property interests, treaty rights, and federally protected Indian affairs. Multiple overlapping legal frameworks may be implicated simultaneously: federal trust responsibility doctrines, the Non-Intercourse Act, federal preemption principles, Indian Country doctrines, tribal governmental protections, fiduciary obligations, treaty protections, and federal constitutional safeguards.", citation: "Snyder Act, 42 Stat. 208 (1921); United States v. Mitchell, 463 U.S. 206 (1983); Cobell v. Salazar, 573 F.3d 808 (D.C. Cir. 2009); United States v. White Mountain Apache Tribe, 537 U.S. 465 (2003); McGirt v. Oklahoma, 591 U.S. ___ (2020); Passamaquoddy Tribe v. Morton, 528 F.2d 370 (1st Cir. 1975); White Mountain Apache Tribe v. Bracker, 448 U.S. 136 (1980); United States v. Jicarilla Apache Nation, 564 U.S. 162 (2011); Morton v. Ruiz, 415 U.S. 199 (1974)" },
      administrative: { label: "Administrative Usage vs. Legal Reality", content: "Agencies routinely apply trust responsibility only to enrolled members of federally recognized tribes on the BIA list — treating it as a funding administration criterion tied to program eligibility. This administrative framing is significantly narrower than the statutory and judicial framework. Courts have recognized trust responsibility toward tribes not on the current BIA list (Passamaquoddy, 1975). Morton v. Ruiz (1974) held agencies cannot impose unpublished or arbitrary eligibility restrictions inconsistent with federal obligations. The administrative criterion governs program access for specific programs — it does not determine the full scope of the underlying legal obligation. Where actions impair tribal lands, tribal governmental functions, protected tribal interests, trust assets, beneficiary welfare, tribal jurisdiction, or federally protected Indian affairs, enforcement responses may include: administrative notice; preservation demands; jurisdictional objections; federal-agency review requests; federal trust responsibility assertions; federal preemption challenges; tribal court remedies; and actions in the United States Court of Federal Claims.", citation: "25 C.F.R. Part 83; Passamaquoddy Tribe v. Morton, 528 F.2d 370 (1st Cir. 1975); Morton v. Ruiz, 415 U.S. 199 (1974); Loper Bright Enterprises v. Raimondo (2024)" },
    },
    patterns: [
      "Framing the trust responsibility as primarily a BIA benefits program rather than an enforceable fiduciary legal obligation.",
      "Conditioning protection on BIA recognition status, CDIB possession, administrative roster placement, or reservation location — these are administrative program criteria, not the limits of the legal obligation.",
      "Agencies citing funding limitations to deny trust obligations — funding adequacy is a separate question from the existence of the legal duty.",
      "Using 'no trust relationship' as a legal conclusion when the statutory, treaty, and judicial basis for that relationship has not been examined under a totality analysis.",
      "Treating the trust responsibility as BIA-centered or administratively-benefits-oriented when courts have recognized it as an enforceable fiduciary principle with remedies including liability, injunctive relief, and actions in the Court of Federal Claims.",
      "Analyzing tribal protection through any single doctrine or administrative classification when multiple overlapping federal frameworks may be implicated simultaneously.",
    ],
  },
  {
