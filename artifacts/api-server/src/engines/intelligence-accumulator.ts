...
const ACTION_DEFINITIONS: ActionDef[] = [
  ...
  },
  {
    ...
    priority: "IMMEDIATE",
    rationale: "A mortgage, lien, or foreclosure action on restricted Indian land is void ab initio under the Nonintercourse Act (25 U.S.C. § 177) without explicit tribal and informed consent. This is not a defense — it is a structural fact: no state court, no lender, and no county recorder has the legal power to encumber restricted Indian land. A Notice of Federal Review formally invokes federal jurisdiction, notifies all parties of the void nature of the encumbrance, and creates the administrative record required for intervention. Any purported federal authorization absent tribal consent would itself be ultra vires and unenforceable.",
    lawCitations: [
      "25 U.S.C. § 177 (Indian Nonintercourse Act — no purchase or encumbrance of Indian land without explicit tribal and informed consent; purported federal action without such consent is ultra vires)",
  ...
  },
  {
    ...
    lawCitations: [
      ...
      "25 U.S.C. § 177 (Nonintercourse Act — treaty lands cannot be encumbered without explicit tribal and informed consent)",
