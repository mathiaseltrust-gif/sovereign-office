...
export const SOVEREIGN_ORGS: SovereignOrg[] = [
  ...
  },
  {
    ...
    jurisdiction: "Mathias El Tribe Sovereign Trust — Treaty-Based Federal Fiduciary",
    description: "Holds and manages trust assets, land, and financial instruments on behalf of enrolled members. Operates under the federal fiduciary duty established by treaty and statute — inherent to the tribal relationship, not contingent on any administrative list.",
  ...
  },
  {
    ...
    description: "Tribal business enterprises majority-owned and controlled by enrolled members. Eligible for SBA Indian set-aside contracts and federal Indian business preferences under inherent sovereign authority.",
