...
const FEDERAL_LAWS = [
  ...
  },
  {
    ...
    body: "No purchase or grant of lands from any Indian nation or tribe shall be valid unless made by treaty or convention entered into pursuant to the Constitution. All alienations of Indian land without explicit tribal and informed consent are void. This statute protects against unauthorized transfers of Indian land. Any mortgage, lien, or commercial encumbrance placed on restricted Indian land without explicit tribal and informed consent is void ab initio — any purported federal action contrary to the Tribe's informed consent would itself be ultra vires. The Non-Intercourse Act applies with full force to tribal governmental facilities, administrative sites, and operational properties — no state or county actor may foreclose upon, encumber, tax, or seize such properties without explicit federal authorization.",
    tags: ["trust-land", "alienation", "nonintercourse", "land-transfer", "debt-invalidation", "admin-process", "credit-protection", "tribal-governmental-facility", "foreclosure", "seizure", "encumbrance"],
  },
  {
    title: "Indian Country Jurisdiction",
    citation: "18 U.S.C. § 1151",
    body: "Indian Country, as used in federal law, means: (a) all land within the limits of any Indian reservation under the jurisdiction of the United States Government, notwithstanding the issuance of any patent, and including rights-of-way running through the reservation; (b) all dependent Indian communities within the borders of the United States whether within the original or subsequently acquired territory thereof, and whether within or without the limits of a state; and (c) all Indian allotments, the Indian titles to which have not been extinguished, including rights-of-way running through the same. Federal and tribal jurisdiction operate within Indian Country; state and county jurisdiction is substantially preempted. Tribal governmental facilities, courts, archives, and operational sites situated within Indian Country are governed by federal and tribal law — county recording requirements, state taxation, and local land-use regulations do not control without explicit federal authorization.",
    tags: ["indian-country", "jurisdiction", "tribal-jurisdiction", "federal-preemption", "reservation", "allotment", "dependent-community", "tribal-governmental-facility"],
  },
  {
    title: "Federal Preemption of State Action in Indian Affairs",
    citation: "U.S. Const. Art. VI; Worcester v. Georgia, 31 U.S. 515 (1832); McClanahan v. Arizona State Tax Comm'n, 411 U.S. 164 (1973); White Mountain Apache Tribe v. Bracker, 448 U.S. 136 (1980)",
    body: "Federal Indian law preempts state and county action that interferes with tribal self-government, federal trust responsibilities, or protected Indian interests. The preemption analysis requires courts to balance federal and tribal interests against state interests — where the federal government has occupied the field or where the state action would undermine tribal sovereignty, federal preemption applies. State taxation of tribal governmental operations is presumptively invalid. State foreclosure, zoning, and regulatory schemes do not apply to tribal governmental facilities without explicit federal authorization. The totality of federal interests — not any single statute — governs the preemption analysis.",
    tags: ["federal-preemption", "state-jurisdiction", "tribal-sovereignty", "worcester", "mcclanahan", "bracker-balancing", "taxation", "foreclosure", "tribal-governmental-facility"],
  },
  {
    title: "Tribal Governmental Facility and Operational Site Multi-Layer Protection Doctrine",
    citation: "25 U.S.C. § 177; 18 U.S.C. § 1151; Federal Trust Responsibility; Worcester v. Georgia; McClanahan v. Arizona; Snyder Act (25 U.S.C. § 13); AIRFA (42 U.S.C. § 1996); VAWA (18 U.S.C. § 2265); IHCIA (25 U.S.C. §§ 1601–1685)",
    body: "Properties functioning as tribal governmental facilities — including but not limited to the Office of the Chief Justice and Trustee, tribal governmental administration centers, tribal court archives, tribal records repositories, charitable trust administration offices, tribal medical and community facilities, and protected tribal operational sites — simultaneously invoke multiple overlapping layers of federal Indian law protection. These protections include: the Non-Intercourse Act (25 U.S.C. § 177) prohibiting unauthorized encumbrances; Indian Country jurisdiction (18 U.S.C. § 1151); federal trust responsibility doctrines; Snyder Act frameworks; tribal governmental function protections; trust and fiduciary protections; judicial and governmental record protections; charitable and beneficiary-interest protections; cultural and ceremonial protections; public welfare and health continuity protections; federal supremacy and preemption principles; and protective-order enforcement mechanisms. TOTALITY STANDARD: These protections are not dependent upon BIA recognition status, CDIB possession, administrative roster placement, or isolated administrative classifications. The ecosystem must analyze whether protected tribal interests, governmental functions, identifiable tribal beneficiaries, tribal continuity interests, protected Indian interests, or federally implicated tribal operations are affected — and must recognize all overlapping layers simultaneously.",
    tags: ["tribal-governmental-facility", "multi-layer-protection", "totality-analysis", "overlapping-jurisdiction", "trust-responsibility", "judicial-continuity", "records-protection", "charitable-trust", "community-health", "cultural-protection", "federal-preemption", "protective-order", "foreclosure", "seizure", "encumbrance", "nonintercourse", "indian-country"],
  },
  {
