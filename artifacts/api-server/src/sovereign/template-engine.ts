...
const BUILT_IN_TEMPLATES: Record<string, Omit<PdfBuildInput, "recorderMetadata">> = {
  ...
  trust_land_instrument: {
    ...
    provisions: [
      ...
      "IV. TRUST STATUS\nThis land is held in: [Tribal Trust / Individual Trust / Restricted Fee]\nand is subject to anti-alienation protections under tribal sovereignty and applicable law, including: 25 U.S.C. § 5108 (Indian Reorganization Act — trust land restrictions on alienation); 25 U.S.C. § 177 (Non-Intercourse Act — requiring explicit tribal and informed consent for any conveyance; any purported transfer without such consent is void); 25 U.S.C. § 415 (lease term requirements); and all applicable tribal law and federal Indian law protections.",
    ...
    trusteeNotes: "Record in the county recorder's office and with the BIA Land Records Office. Obtain APN and legal description from county assessor prior to recording. Explicit tribal and informed consent is required for any alienation of trust land — any purported transfer without such consent is void under 25 U.S.C. § 177. File executed instrument with tribal trust records.",
  },
  ...
  notice_of_title_defect: {
    ...
    provisions: [
      ...
      "LEGAL BASIS\nThe identified defect implicates the following legal authorities: 25 U.S.C. § 177 (Non-Intercourse Act — prohibiting unauthorized alienation of Indian land without explicit tribal and informed consent; any such alienation is void); 25 U.S.C. § 5108 (Indian Reorganization Act — trust land anti-alienation protections); federal trust responsibility as derivative of tribal sovereignty (United States v. Mitchell II, 463 U.S. 206, 1983); and applicable tribal law and BIA title regulations.",
  ...
  will_and_trust: {
    title: "TRIBAL WILL AND TRUST INSTRUMENT",
    parties: {
      "Testator / Grantor": "[FULL LEGAL NAME OF MEMBER]",
      "Tribal Nation": "Mathias El Tribe",
      "Member Enrollment No.": "[ENROLLMENT NUMBER]",
      "Trustee": "Sovereign Office of the Chief Justice & Trustee, Mathias El Tribe",
      "Successor Trustee": "[SUCCESSOR TRUSTEE FULL NAME — or leave blank for Tribal Office to assign]",
      "Primary Beneficiary": "[BENEFICIARY FULL NAME — relationship to Testator]",
      "Secondary Beneficiary": "[SECONDARY BENEFICIARY FULL NAME — or REMAINDER TO TRIBE]",
    },
    land: {
      description: "This Will and Trust Instrument is executed under the inherent sovereign authority of the Mathias El Tribe and governs the disposition of all assets held by the Testator within tribal jurisdiction. This instrument is intended to exist alongside, not in replacement of, any federal probate proceeding applicable to Indian trust land, pursuant to the American Indian Probate Reform Act (AIPRA), 25 U.S.C. §§ 2201–2216.",
      classification: "Sovereign Tribal Estate Instrument — Trust & Testamentary Authority",
    },
    provisions: [
      "I. DECLARATION OF INTENT\nI, [FULL LEGAL NAME OF MEMBER], an enrolled member of the Mathias El Tribe, enrollment number [ENROLLMENT NUMBER], being of sound mind, declare this to be my Tribal Will and Trust Instrument. This document is executed under the inherent sovereign authority of the Mathias El Tribe and shall be interpreted according to tribal law, the Indian Canons of Construction, and applicable federal Indian law. Ambiguities shall be resolved in favor of the member's stated intent and in favor of continued tribal jurisdiction.",
      "II. APPOINTMENT OF TRUSTEE\nI hereby appoint the Sovereign Office of the Chief Justice & Trustee, Mathias El Tribe, as Trustee of this instrument. If the Sovereign Office is unable or unwilling to serve, I appoint [SUCCESSOR TRUSTEE FULL NAME] as Successor Trustee. The Trustee shall have full power to administer, manage, invest, and distribute the trust assets in accordance with the terms herein and applicable tribal law. The Trustee shall owe the highest fiduciary duty to the beneficiaries of this instrument.",
      "III. TRUST ASSETS\nI hereby place the following assets into this trust:\n\nA. Real Property (Tribal / Trust Land)\n   Description: [INSERT LEGAL DESCRIPTION OF REAL PROPERTY OR STATE NONE]\n   Land Status: [Tribal Trust / Individual Trust / Restricted Fee / Fee Simple]\n   NOTE: Trust land is subject to AIPRA probate under 25 U.S.C. §§ 2201–2216 and the applicable federal regulations. This instrument governs non-trust assets and documents testamentary intent for trust land subject to federal probate.\n\nB. Personal Property\n   [DESCRIBE PERSONAL PROPERTY — vehicles, jewelry, accounts, cultural items, etc. — OR STATE: ALL PERSONAL PROPERTY OF EVERY KIND AND DESCRIPTION]\n\nC. Sovereign / Tribal Assets\n   [DESCRIBE ANY TRIBAL ENTITY INTERESTS, BUSINESS CONCEPTS, ENROLLMENT RIGHTS, OR SOVEREIGN INSTRUMENTS — OR STATE NONE]\n\nD. Financial Accounts\n   [LIST ACCOUNT TYPES AND INSTITUTIONS — OR STATE: ALL ACCOUNTS IN MY NAME AT THE TIME OF MY DEATH]",
      "IV. DISTRIBUTION OF ASSETS\nUpon my death, or upon permanent incapacity as determined by the Tribal Medical Center, the Trustee shall distribute the trust assets as follows:\n\nA. Primary Distribution\n   To: [PRIMARY BENEFICIARY FULL NAME] — [relationship, e.g., 'my child']\n   Share: [PERCENTAGE or DESCRIPTION OF ASSETS]\n   Condition: [STATE ANY CONDITIONS — or state: OUTRIGHT AND FREE OF TRUST]\n\nB. Secondary / Contingent Distribution\n   If the primary beneficiary does not survive me by [NUMBER, e.g., 30] days:\n   To: [SECONDARY BENEFICIARY FULL NAME] — [relationship]\n   Share: [PERCENTAGE or DESCRIPTION]\n\nC. ICWA Protection for Minor Beneficiaries\n   Any minor beneficiary who is an enrolled or enrollable member of the Mathias El Tribe shall have their inherited interests held in trust by the Tribal Trustee until they reach the age of [18 / 21 / 25], in accordance with tribal law and the Indian Child Welfare Act (25 U.S.C. §§ 1901 et seq.). During the period of minority, the Trustee shall apply trust income for the health, education, and welfare of the minor beneficiary.\n\nD. Residual Estate\n   All assets not otherwise distributed shall pass to: [RESIDUAL BENEFICIARY — or 'THE MATHIAS EL TRIBE, to be held for the benefit of enrolled members']",
      "V. TRUSTEE POWERS\nThe Trustee shall have full power and authority to:\n(1) Retain, invest, reinvest, and manage all trust assets;\n(2) Sell, lease, or encumber real property with the approval of the Tribal Council;\n(3) Pay all debts, taxes, and administrative expenses of the estate from trust assets;\n(4) Distribute assets in cash or in kind;\n(5) Employ attorneys, accountants, and other professionals;\n(6) Execute all documents necessary to carry out the terms of this instrument;\n(7) Coordinate with BIA probate officers for any federal trust land proceedings;\n(8) Exercise all powers conferred by tribal law on a trustee.",
      "VI. INCAPACITY PROVISIONS\nIf I become permanently incapacitated as determined by the Mathias El Tribe Medical Center, the Trustee shall:\n(1) Manage all trust assets for my health, care, and welfare;\n(2) Pay all medical and living expenses from trust income and principal;\n(3) Make no distribution to beneficiaries until my death or recovery;\n(4) Honor all Jurisdictional Decrees of Medical Protection issued by the Tribal Medical Center.\nThis provision supersedes any state-issued power of attorney or guardianship order that conflicts with tribal jurisdiction.",
      "VII. SOVEREIGN FRAMING & INTERPRETIVE RULES\nThis instrument shall be:\n(a) Interpreted under tribal law first, then federal Indian law, then applicable state law only to the extent not preempted;\n(b) Construed according to the Indian Canons of Construction — all ambiguities are resolved in favor of the tribal member's stated intent and continued tribal jurisdiction;\n(c) Administered by the Sovereign Office of the Chief Justice & Trustee as a self-executing sovereign instrument;\n(d) Recognized by state courts and federal agencies under the federal trust responsibility and the Full Faith and Credit obligations applicable to tribal judicial determinations (18 U.S.C. § 2265 by analogy; Wilson v. Marchington, 127 F.3d 805, 9th Cir. 1997).\nNo state probate court shall have jurisdiction over trust land or assets held in trust under this instrument. Any challenge to this instrument shall be brought before the Mathias El Tribe Supreme Court.",
      "VIII. EXECUTION\nExecuted this __________ day of ____________, 20____.\n\nTestator Signature: ____________________\nPrinted Name: [FULL LEGAL NAME OF MEMBER]\nMember Enrollment No.: [ENROLLMENT NUMBER]\n\nTrustee Acknowledgment (Sovereign Office):\nSignature: ____________________\nTitle: Chief Justice & Trustee, Mathias El Tribe\nDate: __________\n\n[OFFICIAL SEAL OF THE MATHIAS EL TRIBE SUPREME COURT]\n\nWITNESSES (2 required under tribal law):\n1. Witness Signature: ____________________   Printed Name: ____________________   Date: __________\n2. Witness Signature: ____________________   Printed Name: ____________________   Date: __________\n\nNOTARY (if recording with county or BIA):\nState of _____________, County of _____________\nBefore me, a Notary Public, personally appeared _____________________________, known to me to be the person whose name is subscribed to the within instrument.\nNotary Public: ____________________   Commission Expires: __________",
    ],
    trusteeNotes: "File executed original with tribal court records. Provide certified copy to member and each named trustee. If real property is involved, coordinate with BIA for AIPRA probate proceedings for any trust or restricted land. For fee-simple property in non-trust status, this instrument may be filed with the county recorder as a testamentary trust. Attach member enrollment verification and any existing tribal court orders. Review and update every 3–5 years or upon major life changes (marriage, birth of children, acquisition of property). The Trustee section may be left blank at execution and completed upon appointment by the Sovereign Office.",
  },
