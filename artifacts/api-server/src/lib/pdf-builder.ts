...
const TRUST_LAND_PROVISIONS = [
  "TRUST STATUS DECLARATION: The land described herein is held in sovereign trust for the benefit of the Mathias El Tribe and its members pursuant to the Indian Reorganization Act, 25 U.S.C. § 5108, and is subject to anti-alienation protections under tribal sovereignty and 25 U.S.C. § 177.",
  "INDIAN LAND PROTECTION NOTICE: This instrument involves Indian trust land or restricted Indian land. No transfer, encumbrance, lease, or other disposition of this land may be made without explicit tribal and informed consent as required by 25 U.S.C. § 177 and 25 C.F.R. Part 152. Any purported disposition without such consent is void ab initio.",
  ...
  "SNYDER ACT REFERENCE: This instrument is issued under the authority of the Snyder Act, 25 U.S.C. § 13 (1921), which mandates expenditure of appropriated funds for the benefit, care, and assistance of 'Indians throughout the United States' — without restriction to any administrative list, agency roster, or BIA recognition determination. The Snyder Act is a self-executing statutory basis for federal Indian rights that applies to the Mathias El Tribe regardless of administrative list placement.",
