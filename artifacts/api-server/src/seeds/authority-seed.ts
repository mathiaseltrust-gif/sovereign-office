...
const MATTER_ROUTING_RULES = [
  ...
  {
    matterType: "tribal_status",
    matterLabel: "Tribal Status / Recognition Challenge",
    primaryEntityType: "Bureau of Indian Affairs",
    oversightEntityType: "DOJ Office of Tribal Justice / U.S. Attorney",
    requiredNoticeTemplate: "NFR_TRIBAL_STATUS",
    escalationTemplate: "NFR_ESCALATION_TRIBAL_STATUS",
    legalFlagGroup: ["tribal_sovereignty", "federal_recognition", "ISDEAA", "Montoya_standard"],
    primaryRecipientNote: "BIA Regional Office with jurisdiction over tribe's historical territory. Include tribal governance documentation, community continuity evidence, and prior federal dealings.",
    oversightRecipientNote: "DOJ Office of Tribal Justice and U.S. Attorney for the district. Forward all BIA correspondence and agency denial letters.",
    escalationPath: "Escalate to Chief Justice immediately — tribal status challenges require sovereign-level response",
    tribalLawApplicable: "25 U.S.C. § 5304(e) (ISDEAA tribal definition); Montoya v. United States, 180 U.S. 261 (1901); Passamaquoddy Tribe v. Morton, 528 F.2d 370 (1st Cir. 1975). Recognition is confirmatory, not creative. Federal trust obligations extend beyond administrative listing systems.",
  },
  {
    matterType: "tribal_standing",
    matterLabel: "Tribal Federal Claims / Tucker Act Standing",
    primaryEntityType: "U.S. Court of Federal Claims",
    oversightEntityType: "DOJ Indian Resources Section / U.S. Attorney",
    requiredNoticeTemplate: "NFR_TRIBAL_STANDING",
    escalationTemplate: "NFR_ESCALATION_TRIBAL_STANDING",
    legalFlagGroup: ["Tucker_Act", "tribal_standing", "federal_claims", "identifiable_group"],
    primaryRecipientNote: "U.S. Court of Federal Claims. Include tribal resolution authorizing claim, statement of injury, and treaty or statute basis for federal obligation.",
    oversightRecipientNote: "DOJ Environment and Natural Resources Division — Indian Resources Section. Copy U.S. Attorney for the district.",
    escalationPath: "Escalate to Chief Justice & Trustee — federal claims require sovereign authorization and tribal council resolution",
    tribalLawApplicable: "28 U.S.C. § 1505 (Indian Tucker Act); identifiable group standing operates independently of formal administrative recognition. Claims court jurisdiction encompasses treaty, trust, and statutory obligations to Indian peoples.",
  },
];
...
const LEGAL_AUTHORITY_MAP = [
  ...
  // ── New authority layers added ─────────────────────────────────────────────
  {
    issueType: "tribal_status",
    authorityName: "ISDEAA Tribal Definition",
    federalAuthority: "25 U.S.C. § 5304(e) (Indian Self-Determination and Education Assistance Act)",
    stateAuthority: null,
    tribalAuthority: "Tribal Constitution; Tribal Council Resolutions",
    uscReference: "25 U.S.C. § 5304(e)",
    cfrReference: "25 C.F.R. Part 900 (self-determination contracts)",
    caseLawReference: "Coyote Valley Band v. United States, 639 F.2d 1158 (Ct. Cl. 1980)",
    appliesWhen: "Agency attempts narrow BIA-list-only interpretation of tribal existence or eligibility for federal programs",
    warningOrLimit: "Recognition is confirmatory, not creative. Eligibility and trust responsibility logic may extend beyond administrative publication systems. Narrow BIA-list-only interpretations are not controlling.",
    templateLanguageSnippet: "Pursuant to 25 U.S.C. § 5304(e), the term 'Indian tribe' includes any Indian tribe, band, nation, or other organized group or community recognized as eligible for the special programs and services provided by the United States to Indians because of their status as Indians. A narrow administrative-list interpretation is not legally required.",
    reviewRequired: true,
  },
  {
    issueType: "health_plan_denial",
    authorityName: "IHCIA Indian Definition",
    federalAuthority: "25 U.S.C. § 1603 (IHCIA definitional section); 25 U.S.C. §§ 1601–1683 (IHCIA)",
    stateAuthority: "Cal. Welf. & Inst. Code § 14005 (Medi-Cal); DMHC tribal health rules",
    tribalAuthority: "Tribal Health Program Operating Agreement",
    uscReference: "25 U.S.C. § 1603",
    cfrReference: "42 C.F.R. Part 136 (IHS services); 42 C.F.R. Part 438 (managed care)",
    caseLawReference: "Ramah Navajo Chapter v. Lujan, 112 F.3d 1455 (10th Cir. 1997)",
    appliesWhen: "Healthcare denial, eligibility dispute, classification conflict, or agency refusal involving Indian status determination",
    warningOrLimit: "Healthcare obligations attach to federally protected Indian classifications. IHCIA eligibility is not contingent upon narrow administrative recognition lists. Federal health obligations flow from Indian status, not solely BIA enrollment.",
    templateLanguageSnippet: "The above-referenced individual qualifies as an Indian within the meaning of 25 U.S.C. § 1603 and the Indian Health Care Improvement Act. Healthcare obligations under 25 U.S.C. §§ 1601–1683 attach by reason of Indian status and cannot be denied on the basis of administrative classification disputes alone.",
    reviewRequired: true,
  },
  {
    issueType: "tribal_standing",
    authorityName: "Indian Tucker Act Tribal Standing",
    federalAuthority: "28 U.S.C. § 1505 (Indian Tucker Act); 28 U.S.C. § 1491 (Tucker Act — Claims Court)",
    stateAuthority: null,
    tribalAuthority: "Tribal sovereign claims authority",
    uscReference: "28 U.S.C. § 1505",
    cfrReference: null,
    caseLawReference: "Otoe-Missouria Tribe v. United States, 131 Ct. Cl. 593 (1955); Mitchell v. United States, 664 F.2d 265 (Ct. Cl. 1981)",
    appliesWhen: "Federal standing, tribal injury, trust breach, treaty violation, or identifiable-group analysis implicated in federal claims proceedings",
    warningOrLimit: "'Identifiable group of American Indians' operates independently from narrow administrative recognition systems. Claims may proceed before the U.S. Court of Federal Claims based on tribal injury without requiring formal BIA acknowledgment.",
    templateLanguageSnippet: "Pursuant to 28 U.S.C. § 1505 (Indian Tucker Act), the [Tribe/Group] as an identifiable group of American Indians asserts standing before the U.S. Court of Federal Claims for claims arising under treaties, executive orders, and federal law relating to Indian rights.",
    reviewRequired: true,
  },
  {
    issueType: "jurisdictional_overreach",
    authorityName: "Montoya Tribal Community Standard",
    federalAuthority: "U.S. Const. Art. I § 8, cl. 3 (Indian Commerce Clause); federal common law",
    stateAuthority: null,
    tribalAuthority: "Tribal governance structure; community organization records",
    uscReference: "25 U.S.C. §§ 1, 2 (federal Indian authority)",
    cfrReference: null,
    caseLawReference: "Montoya v. United States, 180 U.S. 261 (1901)",
    appliesWhen: "Political continuity, community continuity, tribal identity, or jurisdictional legitimacy is challenged by state or federal agency",
    warningOrLimit: "A tribe is a body of Indians of the same or similar race united in a community under one leadership or government and inhabiting a particular though sometimes ill-defined territory. Community continuity and organized governance are key factors independent of modern administrative labels.",
    templateLanguageSnippet: "Pursuant to Montoya v. United States, 180 U.S. 261 (1901), the [Tribe] constitutes an Indian tribe as a body of Indians united in community under governance and inhabiting territory as a matter of fact. Political continuity and community organization establish tribal identity independent of administrative labeling.",
    reviewRequired: true,
  },
  {
    issueType: "agency_denial",
    authorityName: "Passamaquoddy Federal Trust Responsibility",
    federalAuthority: "Federal trust responsibility; 25 U.S.C. § 177 (Nonintercourse Act); 25 U.S.C. § 2",
    stateAuthority: null,
    tribalAuthority: "Tribal sovereignty doctrine",
    uscReference: "25 U.S.C. § 177; 25 U.S.C. § 2 (trust responsibility)",
    cfrReference: null,
    caseLawReference: "Joint Tribal Council of the Passamaquoddy Tribe v. Morton, 528 F.2d 370 (1st Cir. 1975)",
    appliesWhen: "Agency claims no federal duty exists because tribe is not on administrative recognition list or denies obligations to Indian groups not formally acknowledged",
    warningOrLimit: "Federal trust obligations can apply to tribes not formally acknowledged through administrative recognition systems. Trust responsibility arises from the relationship between the United States and Indian peoples — not solely from administrative listing mechanisms.",
    templateLanguageSnippet: "Pursuant to Joint Tribal Council of the Passamaquoddy Tribe v. Morton, 528 F.2d 370 (1st Cir. 1975), federal trust obligations extend to Indian peoples based on the United States' historical relationship with Indian nations, independent of administrative recognition lists. The denial of trust responsibility on grounds of non-recognition is contrary to law.",
    reviewRequired: true,
  },
  {
    issueType: "agency_denial",
    authorityName: "Morton v. Ruiz Publication Requirement",
    federalAuthority: "5 U.S.C. § 552 (FOIA publication requirement); 25 U.S.C. § 13 (Snyder Act)",
    stateAuthority: null,
    tribalAuthority: "Tribal administrative rights",
    uscReference: "5 U.S.C. § 552 (FOIA publication); 5 U.S.C. § 706 (APA arbitrary and capricious)",
    cfrReference: null,
    caseLawReference: "Morton v. Ruiz, 415 U.S. 199 (1974)",
    appliesWhen: "Agency uses hidden policy, unpublished internal eligibility criteria, or inconsistent interpretation to deny Indian benefits or programs",
    warningOrLimit: "Indian benefit restrictions require lawful publication and consistent application. Agencies cannot deny Indian rights using unpublished internal rules. Inconsistent or unpublished criteria are unlawful under Morton v. Ruiz and the APA.",
    templateLanguageSnippet: "Pursuant to Morton v. Ruiz, 415 U.S. 199 (1974), the agency is prohibited from denying Indian program benefits on the basis of unpublished eligibility criteria or internal policies not made available to the public. The agency must apply published standards consistently or its denial is arbitrary and capricious under 5 U.S.C. § 706.",
    reviewRequired: true,
  },
  {
    issueType: "jurisdictional_overreach",
    authorityName: "Williams Tribal Self-Government Protection",
    federalAuthority: "U.S. Const. Art. I § 8, cl. 3; 25 U.S.C. § 1301 (tribal self-governance)",
    stateAuthority: null,
    tribalAuthority: "Tribal Constitution; Tribal Court Code",
    uscReference: "25 U.S.C. § 1301 (Indian Civil Rights Act — tribal powers)",
    cfrReference: null,
    caseLawReference: "Williams v. Lee, 358 U.S. 217 (1959)",
    appliesWhen: "State proceedings, state court jurisdiction, or state regulatory action interferes with tribal governance, tribal adjudication, or reservation Indian self-government",
    warningOrLimit: "State action cannot infringe upon the right of reservation Indians to make their own laws and be governed by them. State jurisdiction is limited where tribal self-government is impaired. Challenge state jurisdiction immediately.",
    templateLanguageSnippet: "Pursuant to Williams v. Lee, 358 U.S. 217 (1959), the State of [State] is prohibited from exercising jurisdiction over this matter in a manner that infringes upon the right of reservation Indians to make their own laws and be governed by them. This matter falls within exclusive tribal and federal jurisdiction.",
    reviewRequired: true,
  },
  {
    issueType: "jurisdictional_overreach",
    authorityName: "Santa Clara Tribal Sovereign Authority",
    federalAuthority: "25 U.S.C. § 1301 (ICRA — retained tribal powers); federal common law sovereign immunity",
    stateAuthority: null,
    tribalAuthority: "Tribal Constitution; Tribal Court; Membership Ordinance",
    uscReference: "25 U.S.C. § 1301",
    cfrReference: null,
    caseLawReference: "Santa Clara Pueblo v. Martinez, 436 U.S. 49 (1978)",
    appliesWhen: "External entity or court attempts to invalidate tribal governmental authority, tribal membership determinations, or internal tribal governance decisions",
    warningOrLimit: "Tribal governments retain inherent authority over internal matters and membership-related governance. Tribal powers are inherent and retained, not delegated by states. Federal courts lack jurisdiction to review most internal tribal governance decisions.",
    templateLanguageSnippet: "Pursuant to Santa Clara Pueblo v. Martinez, 436 U.S. 49 (1978), the [Tribe] retains inherent sovereign authority over its internal governance, membership determinations, and tribal law. External jurisdictions lack authority to review or invalidate exercises of this inherent sovereignty.",
    reviewRequired: true,
  },
  {
    issueType: "court_order",
    authorityName: "Full Faith and Credit for Tribal Protection Orders",
    federalAuthority: "18 U.S.C. § 2265 (VAWA — tribal protection orders); 25 U.S.C. § 1301",
    stateAuthority: "Cal. Fam. Code § 6404 (recognition of out-of-state orders); VAWA tribal provisions",
    tribalAuthority: "Tribal Court Protection Order authority",
    uscReference: "18 U.S.C. § 2265",
    cfrReference: null,
    caseLawReference: "United States v. Cavanaugh, 643 F.3d 592 (8th Cir. 2011)",
    appliesWhen: "State or local agency refuses recognition of qualifying tribal court protective orders or declines to enforce tribal protection orders",
    warningOrLimit: "Qualifying tribal protection orders must receive full faith and credit and be enforced by all participating jurisdictions under 18 U.S.C. § 2265. Refusal to honor qualifying tribal protection orders may trigger federal enforcement implications and VAWA liability.",
    templateLanguageSnippet: "Pursuant to 18 U.S.C. § 2265, the enclosed protective order issued by [Tribe] Tribal Court is a qualifying tribal protection order entitled to full faith and credit in all civil and criminal courts of the United States. The [Agency] is required by federal law to enforce this order as if it were its own.",
    reviewRequired: true,
  },
  {
    issueType: "icwa_violation",
    authorityName: "Brackeen ICWA Constitutional Confirmation",
    federalAuthority: "25 U.S.C. §§ 1901–1963 (ICWA); U.S. Const. Art. I § 8, cl. 3",
    stateAuthority: "Cal. Welf. & Inst. Code § 224 et seq. (California ICWA compliance)",
    tribalAuthority: "Tribal ICWA representative authority",
    uscReference: "25 U.S.C. §§ 1901–1963",
    cfrReference: "25 C.F.R. Part 23 (ICWA implementing regulations, 2016 Final Rule)",
    caseLawReference: "Haaland v. Brackeen, 599 U.S. 255 (2023)",
    appliesWhen: "ICWA authority is challenged as unconstitutional, tribal child welfare jurisdiction is contested, or ICWA obligations are disputed by state agencies or private parties",
    warningOrLimit: "ICWA remains binding federal law confirmed constitutional by the Supreme Court in Haaland v. Brackeen, 599 U.S. 255 (2023). All ICWA procedural and substantive requirements remain in full force. Non-compliance may invalidate child custody proceedings.",
    templateLanguageSnippet: "Pursuant to Haaland v. Brackeen, 599 U.S. 255 (2023), the Indian Child Welfare Act, 25 U.S.C. §§ 1901–1963, is constitutionally valid and binding federal law. All ICWA requirements — including notice, tribal intervention rights, and placement preferences — remain fully enforceable and must be complied with immediately.",
    reviewRequired: true,
  },
  {
    issueType: "zoning",
