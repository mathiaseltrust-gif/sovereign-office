...
export function MapPickerModal({ initialLat, initialLng, onConfirm, onCancel }: MapPickerModalProps) {
          ...
          <form onSubmit={handleSearch} className="flex gap-2">
            <div className="relative flex-1">
              ...
              <input
                ...
                placeholder='Search a place, e.g. "Montgomery, Alabama"'
        ...
        <div className="flex items-center justify-between gap-3 px-5 py-3.5 border-t border-border">
          ...
          <div className="flex gap-2 shrink-0">
            ...
            <Button
              ...
              onClick={() => pickedLat != null && pickedLng != null && onConfirm(pickedLat, pickedLng)}
